...
export const CARD_DESIGNS = [
  {
    id: "legend",
    name: "Legend Gold",
    swatch: "from-yellow-200 via-yellow-600 to-black",
    card: "from-yellow-100 via-yellow-500 to-black",
  ...
  },
  {
    id: "neon",
    name: "Neon Purple",
    swatch: "from-fuchsia-400 via-purple-700 to-black",
    card: "from-fuchsia-300 via-purple-700 to-black",
  ...
  },
  {
    id: "carbon",
    name: "Carbon Blue",
    swatch: "from-cyan-200 via-blue-800 to-black",
    card: "from-cyan-200 via-blue-700 to-black",
    text: "text-cyan-200",
    background: "carbon"
  },
  {
    id: "platinum",
    name: "Platin White",
    swatch: "from-white via-zinc-300 to-yellow-700",
    card: "from-white via-zinc-300 to-yellow-700",
  ...
  },
  {
    id: "emerald",
    name: "Emerald",
    swatch: "from-emerald-300 via-green-800 to-black",
    card: "from-emerald-300 via-green-700 to-black",
...
export function getFlag(code: string) {
  return NATIONAL_FLAGS.find((item) => item.code === code)?.flag || "🏳️";
}

export function getCardDesign(id: string) {
  return CARD_DESIGNS.find((item) => item.id === id) || CARD_DESIGNS[0];
}
