...
- CSS clip-path Rahmen entfernt
- Neuer stabiler SVG-Wappenrahmen
- Export bleibt nicht mehr rechteckig wegen CSS-Clip-Problemen
- Karten-Level aus der Bedienung entfernt
- Karten-Design ist jetzt die einzige Design-Auswahl
- Flaggen werden als grafische Auswahlbuttons angezeigt


## Pack Opening entfernt

- Pack Opening komplett aus der Web-App entfernt
- Rechte Seitenleiste auf Stats, Export-Hinweise und Funktionen reduziert
- Stabilere Darstellung auf Vercel


## Build Fix

- Letzte alten Pack-Opening Referenzen entfernt
- `setPackOpening` Fehler behoben
