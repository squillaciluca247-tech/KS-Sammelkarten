  ...
  return (
    <div className="flex justify-center">
      <motion.div whileHover={{ rotateX: 5, rotateY: -5, scale: 1.02 }} transition={{ type: "spring", stiffness: 160 }}>
        <div
          ref={cardRef}
          className={`relative w-[360px] md:w-[430px] aspect-[1080/1600] rounded-[42px] p-[5px] bg-gradient-to-b ${theme.border} shadow-[0_0_80px_rgba(245,197,66,.35)] animate-cardGlow`}
        >
