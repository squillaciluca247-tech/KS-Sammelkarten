...
export default function CardPreview({ rider, traits, photo, clubLogo, regionLogo, back, cardRef }: Props) {
  ...
  return (
    <div className="flex justify-center">
      <div ref={cardRef} data-export-card className="export-safe card-shadow relative h-[720px] w-[405px] overflow-hidden rounded-[34px] bg-[#050403]">
        <div className={`absolute inset-[14px] rounded-[30px] ${design.bg}`} />
        <div className="absolute inset-[14px] rounded-[30px] bg-[linear-gradient(115deg,transparent_0_20%,rgba(255,255,255,.11)_22%,transparent_30%,transparent_63%,rgba(255,215,0,.10)_66%,transparent_72%)]" />

        <svg className="pointer-events-none absolute inset-0 z-30 h-full w-full" viewBox="0 0 405 720" preserveAspectRatio="none">
          <defs>
            <linearGradient id="frameMain" x1="0" y1="0" x2="1" y2="1">
          ...
          <path d="M32 90 L70 28 L155 28 L178 10 L203 32 L227 10 L250 28 L335 28 L373 90 L373 590 L340 660 L203 702 L65 660 L32 590 Z" fill="url(#frameMain)" filter="url(#softShadow)" />
          <path d="M48 98 L80 49 L160 49 L182 31 L203 50 L223 31 L245 49 L325 49 L357 98 L357 572 L327 634 L203 672 L78 634 L48 572 Z" fill="#050403" opacity=".96" />
          <path d="M62 108 L90 66 L166 66 L185 51 L203 67 L220 51 L239 66 L315 66 L343 108 L343 558 L317 615 L203 650 L88 615 L62 558 Z" fill="none" stroke="url(#frameMain)" strokeWidth="4" opacity=".92" />
        ...
        {!back ? (
          <div className="relative z-20 flex h-full flex-col px-[58px] pb-[70px] pt-[72px] text-white">
            <div className="absolute left-[58px] top-[88px] z-20">
            ...
            <div className="absolute right-[60px] top-[82px] z-20 flex flex-col items-end gap-2">
            ...
            <div className="relative mt-[22px] h-[318px] overflow-hidden rounded-[32px]">
              {photo ? (
                <>
                  <img
                    src={photo}
                  ...
                  />
                  <div style={{ background: `radial-gradient(circle at center, transparent 36%, rgba(5,4,3,${rider.vignette / 100}) 73%, rgba(5,4,3,.98) 100%)` }} className="absolute inset-0" />
                ...
                <div className="flex h-full items-center justify-center rounded-[32px] border border-yellow-700/40 bg-black/35 text-zinc-500">
                  FOTO HOCHLADEN
                </div>
              )}
            </div>
            ...
            <div className="-mt-4 text-center">
              <h2 className="font-black uppercase leading-none tracking-wide drop-shadow-lg" style={{ color: design.text, fontSize: `${rider.nameSize}px` }}>
                {rider.name}
              </h2>
              <p className="mt-2 text-[17px] font-semibold text-zinc-100 drop-shadow-md">{rider.bike} · {rider.location}</p>
            </div>

            <div className="mt-4 rounded-2xl border border-yellow-500/55 bg-black/64 px-3 py-3 shadow-[inset_0_0_20px_rgba(0,0,0,.65)]">
            ...
            <div className="mt-4 grid grid-cols-2 gap-x-3 gap-y-3 rounded-2xl border border-yellow-700/45 bg-black/62 p-4 text-[11px] shadow-[inset_0_0_24px_rgba(0,0,0,.7)]">
          ...
          <div className="relative z-20 flex h-full flex-col items-center px-[62px] py-[82px] text-center text-white">
            ...
            <div className="mt-7 w-full rounded-2xl border border-yellow-700/50 bg-black/62 p-4 text-left text-sm">
            ...
            <div className="mt-5 w-full rounded-2xl border border-yellow-700/50 bg-black/62 p-4 text-left text-xs">
