...
const labelClass = "text-xs uppercase tracking-wide text-yellow-300 font-black";
    ...
    <Card className="premium-panel rounded-[26px]">
      <CardContent className="p-5 space-y-5">
        <div className="flex items-center gap-3 border-b border-yellow-800/30 pb-4">
          ...
          <div>
            <h1 className="text-2xl font-black tracking-wide text-yellow-200">KARTEN EDITOR</h1>
        ...
        <section className="space-y-3">
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            <label>
              <span className="mb-1 block text-xs text-zinc-400">Karten-Level</span>
              <select
                className={inputClass}
                value={rider.level}
